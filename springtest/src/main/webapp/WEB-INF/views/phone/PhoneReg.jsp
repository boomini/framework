        ...
        $(document).ready(function () {
            $("#registerBtn").click(function () {
                if (!$("#num").val()) {
                    ...
                    alert("상품가격 입력!!!!");
                    return;
                }else if (!$("#vcode option:selected").val()) {
                	console.log($("#vcode option:selected").val())
                    alert("제조사 선택!!!!");
                    return;
                }
                else {
                    $("#writeform").attr("action", "${root}/phone/register").submit();
                }
            });
        });
    </script>
	  ...
	  <table border="0" cellpadding="0" cellspacing="1" width="590" bgcolor="BBBBBB">
		  <tr>
			...
			<td width=490 bgcolor="ffffff" style="padding-left:10">
				<input type="text" id="num" name="num" style="width:150" name="num"/>  
			</td>
		  </tr>
		  <tr>
			<td width=100 align=center bgcolor="E6ECDE" height="22">모 델 명</td>
			<td width=490 bgcolor="ffffff" style="padding-left:10">
				<input type="text" id="model" name="model" style="width:150" name="model"/>
			</td>
		  </tr>
		  <tr>
			<td width=100 align=center bgcolor="E6ECDE" height="22">가&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;격</td>
			<td width=490 bgcolor="ffffff" style="padding-left:10">
				<input type="text" id="price" name="price"style="width:240" name="price"/>원
			</td>
		  </tr>
		  <tr>
