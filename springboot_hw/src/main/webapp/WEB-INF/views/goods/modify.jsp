        ...
        $(document).ready(function () {
            $("#modifyBtn").click(function () {
                if (!$("#item_code").val()) {
                    ...
                    $("#writeform").attr("action", "${root}/goods/modify").submit();
                }
            });
        });
    </script>
...
<body>
    <div class="container text-center mt-3">
        <div class="col-lg-8 mx-auto">
            ...
            <input type="hidden" class="form-control" id="item_code" name="item_code" value="${itemvo.item_code}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="item_name" name="item_name" value="${itemvo.item_name}">
                </div>
                <div class="form-group">
                    <label for="item_price">판매가:</label>
                    <input type="text" class="form-control" id="item_price" name="item_price" value="${itemvo.item_price}">
                </div>
                <div class="form-group">
                    <label for="item_corp">공급사:</label>
                    <input type="text" class="form-control" id="item_corp" name="item_corp" value="${itemvo.item_corp}">
                </div>
                <div class="form-group">
