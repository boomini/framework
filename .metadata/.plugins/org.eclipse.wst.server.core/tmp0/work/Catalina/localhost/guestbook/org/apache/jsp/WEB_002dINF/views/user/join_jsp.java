 ...
 * Generated at: 2021-10-20 02:59:40 UTC
...
public final class join_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        	var isId = true;\r\n");
      out.write("        	// 아이디 중복검사\r\n");
      out.write("        	/*\r\n");
      out.write("        	$(\"#userid\").keyup(function () {\r\n");
      out.write("        		var ckid = $(\"#userid\").val();\r\n");
      out.write("        		if(ckid.length < 6 || ckid.length > 16) {\r\n");
      out.write("        			$(\"#idresult\").text(\"아이디는 6자이상 16자이하입니다.\").removeClass('text-primary').removeClass('text-danger').addClass('text-dark');\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${root}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/user',\r\n");
      out.write("	                	data: {'act': 'idcheck', 'ckid': ckid},\r\n");
      out.write("	                  	type: 'GET',\r\n");
      out.write("	                  	dataType: 'xml',\r\n");
      out.write("	                  	success: function (response) {\r\n");
      out.write("	                  		console.log(response);\r\n");
      out.write("	                    	var cnt = parseInt($(response).find(\"idcount\").text());\r\n");
      out.write("	                    	if(cnt == 0) {\r\n");
      out.write("	                    		$(\"#idresult\").text(ckid + \"는 사용가능합니다.\").removeClass('text-dark').removeClass('text-danger').addClass('text-primary');\r\n");
      out.write("	                    		isId = true;\r\n");
      out.write("	                    	} else {\r\n");
      out.write("	                    		$(\"#idresult\").text(ckid + \"는 사용할 수 없습니다.\").removeClass('text-dark').removeClass('text-primary').addClass('text-danger');\r\n");
      out.write("	                    		isId = false;\r\n");
      out.write("	                    	}\r\n");
      out.write("	                  	}\r\n");
      out.write("					});\r\n");
      ...
      out.write("                    return;\r\n");
      out.write("                } else if (!isId) {\r\n");
      out.write("                    alert(\"아이디 확인!!!\");\r\n");
      out.write("                    return;\r\n");
      out.write("                } else if (!$(\"#userpwd\").val()) {\r\n");
      out.write("                    alert(\"비밀번호 입력!!!\");\r\n");
      out.write("                    return;\r\n");
      out.write("                } else if ($(\"#userpwd\").val() != $(\"#pwdcheck\").val()) {\r\n");
      out.write("                    alert(\"비밀번호 확인!!!\");\r\n");
      out.write("                    return;\r\n");
      out.write("                } else {\r\n");
      out.write("                	$(\"#email\").val($(\"#emailid\").val()+\"@\"+$(\"#emaildomain\").val())\r\n");
      out.write("                    $(\"#memberform\").attr(\"action\", \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${root}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/user/register\").submit();\r\n");
      out.write("                }\r\n");
      out.write("            });\r\n");
      out.write("\r\n");
      ...
      out.write("            <h2 class=\"p-3 mb-3 shadow bg-light\"><mark class=\"orange\">회원가입</mark></h2>\r\n");
      out.write("            <form id=\"memberform\" class=\"text-left mb-3\" method=\"post\" action=\"\">\r\n");
      out.write("            <input type=\"hidden\" id=\"email\" name=\"email\">    \r\n");
      out.write("                <div class=\"form-group\">\r\n");
      out.write("                    <label for=\"username\">이름</label>\r\n");
      out.write("                    <input type=\"text\" class=\"form-control\" id=\"username\" name=\"userName\" placeholder=\"이름입력...\">\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group\">\r\n");
      out.write("                    <label for=\"userid\">아이디</label>\r\n");
      out.write("                    <input type=\"text\" class=\"form-control\" id=\"userid\" name=\"userId\" placeholder=\"아이디입력...\">\r\n");
      out.write("                    <div id=\"idresult\" class=\"mt-1\"></div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group\">\r\n");
      out.write("                    <label for=\"userpwd\">비밀번호</label>\r\n");
      out.write("                    <input type=\"password\" class=\"form-control\" id=\"userpwd\" name=\"userPwd\" placeholder=\"비밀번호입력...\">\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group\">\r\n");
      out.write("                    <label for=\"pwdcheck\">비밀번호재입력</label>\r\n");
      out.write("                    <input type=\"password\" class=\"form-control\" id=\"pwdcheck\" name=\"pwdcheck\" placeholder=\"비밀번호재입력...\">\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group\">\r\n");
      out.write("                    <label for=\"emailid\">이메일</label><br>\r\n");
      out.write("                    <div id=\"email\" class=\"custom-control-inline\">\r\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"emailid\" name=\"emailid\" placeholder=\"이메일아이디입력...\"\r\n");
      out.write("                            size=\"25\"> @\r\n");
      out.write("                        <select class=\"form-control\" id=\"emaildomain\" name=\"emaildomain\">\r\n");
      ...
      out.write("                <!--\r\n");
      out.write("                <div class=\"form-group\">\r\n");
      out.write("                    <label for=\"tel1\">전화번호</label>\r\n");
      ...
      out.write("                        </select> _\r\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"tel2\" name=\"tel2\" placeholder=\"\"> _\r\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"tel3\" name=\"tel3\" placeholder=\"\">\r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group\">\r\n");
      out.write("                    <label for=\"zipcode\">주소</label><br>\r\n");
      out.write("                    <div id=\"addressdiv\" class=\"custom-control-inline\">\r\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"zipcode\" name=\"zipcode\" placeholder=\"우편번호\" size=\"7\"\r\n");
      out.write("                            maxlength=\"5\" readonly=\"readonly\">\r\n");
      out.write("                    </div>\r\n");
      out.write("                    <input type=\"text\" class=\"form-control\" id=\"address\" name=\"address\" placeholder=\"\">\r\n");
      out.write("                    <input type=\"text\" class=\"form-control\" id=\"address_detail\" name=\"address_detail\" placeholder=\"\">\r\n");
      out.write("                </div>\r\n");
      out.write("                -->\r\n");
      out.write("                <div class=\"form-group text-center\">\r\n");
      out.write("                    <button type=\"button\" id=\"registerBtn\" class=\"btn btn-outline-primary\">회원가입</button>\r\n");
      out.write("                    <button type=\"reset\" class=\"btn btn-outline-danger\">초기화</button>\r\n");
      out.write("                </div>\r\n");
      out.write("            </form>\r\n");
      out.write("        </div>\r\n");
      out.write("    </div>\r\n");
      out.write("    <!-- 우편번호 검색 모달 -->\r\n");
      out.write("    <!--\r\n");
      ...
      out.write("                                placeholder=\"검색 할 도로명 입력(예: 대왕판교로, 학하서로)\">\r\n");
      out.write("                            <span class=\"input-group-btn\">\r\n");
      out.write("                                <input type=\"submit\" class=\"btn btn-warning\" value=\"검색\" id=\"searchBtn\">\r\n");
      out.write("                            </span>\r\n");
      out.write("                        </div>\r\n");
      out.write("                    </form>\r\n");
